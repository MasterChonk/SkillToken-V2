...
contract ERC721 is ERC165, IERC721, IERC721Metadata {
    ...
    //перевірка чи існує такий токен
    ...
    function setApprovalForAll(address operator, bool approved) public {
        ...
        revert("not set approval for all");
    }
    ...
    //перевырка чи існує адрес з таким id токену
    ...
    // }
    /*функції які працють перед і після передачі токенів не дуже треба*/
